def decr_merge(lista_esquerda,lista_direita):
...
def decr_merge_sort(L):
    ...
    lista_esquerda_ordenada=decr_merge_sort(lista_esquerda)
    lista_direita_ordenada=decr_merge_sort(lista_direita)
    #agrupar as listas ordenadas com o merge
    L=decr_merge(lista_esquerda_ordenada, lista_direita_ordenada)
    return L
L=[5,4,3,2,1]
print(decr_merge_sort(L))
