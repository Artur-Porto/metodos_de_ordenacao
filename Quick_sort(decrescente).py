def decr_quick_sort(L):
    ...
    return decr_quick_sort(sub_lista_da_esquerda)+elementos_iguais_ao_pivo+decr_quick_sort(sub_lista_da_direita)
            
        
L=[5,4,3,2,1]
print(decr_quick_sort(L))
